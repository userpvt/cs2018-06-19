...
public class TaskB1 {
    public static void main(String[] args) {
        ...
        int i = sc.nextInt();
            if(i%100==0&&i%400==0||i%4==0&&i!=1700&&i!=1800&&i!=1900)
            System.out.println("количество дней в году: 366");//високос
        else
            System.out.println("количество дней в году: 365");//обычный
