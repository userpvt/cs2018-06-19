...
class TaskA1 {
    public static void main(String[] args) {
        ...
        int a = scan.nextInt(), b = scan.nextInt(), isum, idif, imult, idiv, ic;
        double dsum, ddif, dmult, ddiv, dc;
        isum = a + b; idif = a - b; imult = a * b; idiv = a / b; ic = a%b;
        dsum = a + b; ddif = a - b; dmult = a * b; ddiv = (double)a/b; dc = a%b;
        System.out.println(isum + " " + idif +" " + imult + " " + idiv + " " + ic);
        System.out.println(dsum + " " + ddif + " " + dmult + " " + ddiv + " " + dc);
    }
}
