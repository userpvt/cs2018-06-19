...
class TaskA2 {
    public static void main(String[] args) {
        String a="Я узнал, что у меня Есть огромная семья:";
        String b="И тропинка, и лесок, В поле – каждый колосок!";
        String c="Речка, небо голубое – Это все мое, родное.";
        String d="Это Родина моя! Всех люблю на свете я!";
        String e="(OST) Брат-2";
